...
public class JsonFileDataAttribute : DataAttribute
{
    ...
    public override IEnumerable<object[]> GetData(MethodInfo testMethod)
    {
        ...
        if (string.IsNullOrEmpty(_propertyName))
        {
            ...
            ProductionRequestDto? testData = JsonSerializer.Deserialize<ProductionRequestDto>(fileData, options);
            var array = new ProductionRequestDto[] { testData };
            var list = new List<ProductionRequestDto[]> { array };
            return list;
        }
